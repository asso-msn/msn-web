...
class Pager:
    items_total: int = 0
    index: int = 0  # Current selected item index in the iterable
    pages_total: int = 0
    ...
    def __init__(
        ...
        self.index = self.per_page * (self.current - 1)
    ...
    def has_next(self) -> bool:
        return self.current < self.pages_total
